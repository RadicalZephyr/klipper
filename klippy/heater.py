...
class Heater:
    ...
    def cmd_SET_HEATER_TEMPERATURE(self, params):
        ...
        temp = self.gcode.get_float("TARGET", params, 0.0)
...
class ControlPID:
    def __init__(self, heater, config):
        ...
        imax = config.getfloat("pid_integral_max", self.heater_max_power, minval=0.0)
...
class PrinterHeaters:
    ...
    def setup_sensor(self, config):
        ...
        self.printer.try_load_module(config, "ad849x")
