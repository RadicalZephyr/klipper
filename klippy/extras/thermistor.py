...
class Thermistor:
    ...
    def setup_coefficients(self, t1, r1, t2, r2, t3, r3, name=""):
        ...
        inv_t1 = 1.0 / (t1 - KELVIN_TO_CELCIUS)
        inv_t2 = 1.0 / (t2 - KELVIN_TO_CELCIUS)
        inv_t3 = 1.0 / (t3 - KELVIN_TO_CELCIUS)
        ln_r1 = math.log(r1)
        ln_r2 = math.log(r2)
        ln_r3 = math.log(r3)
    ...
    def calc_adc(self, temp):
        ...
        if temp <= KELVIN_TO_CELCIUS:
            return 1.0
        inv_t = 1.0 / (temp - KELVIN_TO_CELCIUS)
        if self.c3:
...
Sensors = {
    ...
    "NTC 100K beta 3950": {"t1": 25.0, "r1": 100000.0, "beta": 3950.0},
    "Honeywell 100K 135-104LAG-J01": {"t1": 25.0, "r1": 100000.0, "beta": 3974.0},
    "NTC 100K MGB18-104F39050L32": {"t1": 25.0, "r1": 100000.0, "beta": 4100.0},
}
