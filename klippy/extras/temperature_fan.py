...
class TemperatureFan:
    def __init__(self, config):
        ...
        self.fan = fan.PrinterFan(config, default_shutdown_speed=1.0)
        ...
        self.max_speed = config.getfloat("max_speed", 1.0, above=0.0, maxval=1.0)
        self.min_speed = config.getfloat("min_speed", 0.3, minval=0.0, maxval=1.0)
        self.last_temp = 0.0
