...
class ForceMove:
    ...
    def cmd_STEPPER_BUZZ(self, params):
        ...
        toolhead = self.printer.lookup_object("toolhead")
        for i in range(10):
            self.manual_move(stepper, 1.0, BUZZ_VELOCITY)
    ...
    def cmd_FORCE_MOVE(self, params):
        ...
        speed = self.gcode.get_float("VELOCITY", params, above=0.0)
        accel = self.gcode.get_float("ACCEL", params, 0.0, minval=0.0)
        logging.info(
