...
class DisplayBase:
    def __init__(self, io):
        ...
        self.all_framebuffers = [
            (self.vram[i], bytearray("~" * 128), i) for i in range(8)
        ]
...
class SPI4wire:
    def __init__(self, config, data_pin_name):
        self.spi = extras.bus.MCU_SPI_from_config(config, 0, default_speed=10000000)
...
class ST7567(DisplayBase):
    def __init__(self, config):
        ...
        self.reset_pin.setup_start_value(
            start_value=1.0, shutdown_value=0.0, is_static=False
        )
...
class SSD1306(DisplayBase):
    ...
    def init(self):
        ...
        init_cmds = [
            ...
            0x81,
            0xEF,  # Set contrast control
            0xD9,
            0xA1,  # Set pre-charge period
            0xDB,
            0x00,  # Set VCOMH deselect level
