...
class MAX31865(SensorBase):
    def __init__(self, config):
        ...
        self.reference_r = config.getfloat("rtd_reference_r", 430.0, above=0.0)
        SensorBase.__init__(self, config, "MAX31865", self.build_spi_init(config))
    ...
    def calc_temp(self, adc, fault):
        ...
        temp = (
            ...
            + math.sqrt(
                (self.rtd_nominal_r ** 2 * VAL_A * VAL_A)
