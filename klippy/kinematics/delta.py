...
class DeltaKinematics:
    def __init__(self, toolhead, config):
        ...
        rail_a = stepper.PrinterRail(stepper_configs[0], need_position_minmax=False)
        ...
        self.very_slow_xy2 = (ratio_to_dist(2.0 * SLOW_RATIO) - radius) ** 2
        self.max_xy2 = (
            min(
                radius,
                min_arm_length - radius,
                ratio_to_dist(4.0 * SLOW_RATIO) - radius,
            )
            ** 2
        )
        logging.info(
