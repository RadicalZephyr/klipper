...
class ConfigWrapper:
    ...
    def _get_wrapper(
        self, parser, option, default, minval=None, maxval=None, above=None, below=None
    ):
        if default is not sentinel and not self.fileconfig.has_option(
            self.section, option
        ):
            return default
    ...
    def getfloat(
        self, option, default=sentinel, minval=None, maxval=None, above=None, below=None
    ):
        return self._get_wrapper(
            self.fileconfig.getfloat, option, default, minval, maxval, above, below
        )
...
class PrinterConfig:
    ...
    def read_main_config(self):
        ...
        self._config = self._build_config_wrapper(
