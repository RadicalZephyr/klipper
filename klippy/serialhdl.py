...
class SerialReader:
    ...
    def connect(self):
        ...
        while 1:
            ...
            if connect_time > start_time + 150.0:
            ...
            try:
                ...
                self.reactor.pause(connect_time + 5.0)
                continue
            if self.baud:
            ...
            try:
                identify_data = self._get_identify_data(connect_time + 5.0)
            except error as e:
    ...
    def _handle_unknown_init(self, params):
        logging.debug(
            "Unknown message %d (len %d) while identifying",
            params["#msgid"],
            len(params["#msg"]),
        )
    ...
    def handle_unknown(self, params):
        logging.warn(
            "Unknown message type %d: %s", params["#msgid"], repr(params["#msg"])
        )
...
class SerialRetryCommand:
    ...
    def get_response(self, cmds, cmd_queue, minclock=0, minsystime=0.0):
